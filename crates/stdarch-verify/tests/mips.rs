...
fn verify_all_signatures() {
    ...
    for rust in FUNCTIONS {
        ...
        match rust.name {
            "break_" => continue,
            "__msa_bclr_d" => continue,
            "__msa_bclri_b" => continue,
            "__msa_binsli_b" => continue,
            "__msa_binsli_h" => continue,
            "__msa_binsli_w" => continue,
            "__msa_binsli_d" => continue,
            "__msa_binsri_b" => continue,
            "__msa_binsri_h" => continue,
            "__msa_binsri_w" => continue,
            "__msa_binsri_d" => continue,
            "__msa_bmnzi_b" => continue,
            "__msa_bmz_v" => continue,
            "__msa_bmzi_b" => continue,
            "__msa_bneg_d" => continue,
            "__msa_bsel_v" => continue,
            "__msa_bset_d" => continue,
            "__msa_cfcmsa" => continue,
            "__msa_ctcmsa" => continue,
            "__msa_ceqi_d" => continue,
            "__msa_clei_s_d" => continue,
            "__msa_clti_s_d" => continue,
            "__msa_copy_u_d" => continue,
            "__msa_ld_b" => continue,
            "__msa_ld_h" => continue,
            "__msa_ld_w" => continue,
            "__msa_ldi_h" => continue,
            "__msa_ldi_w" => continue,
            "__msa_ldi_d" => continue,
            "__msa_maxi_s_d" => continue,
            "__msa_mini_s_d" => continue,
            "__msa_ori_b" => continue,
            "__msa_slli_b" => continue,
            "__msa_srli_b" => continue,
            "__msa_st_b" => continue,
            "__msa_st_h" => continue,
            "__msa_st_w" => continue,
            _ => {}
