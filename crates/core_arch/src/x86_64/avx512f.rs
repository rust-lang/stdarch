...
mod tests {
    ...
    unsafe fn test_mm512_rol_epi64() {
        let a = _mm512_set_epi64( 1<<63, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32 );
        let r = _mm512_rol_epi64(a, 1);
        let e = _mm512_set_epi64( 1<<0, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_maskz_rol_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<63 );
    ...
    unsafe fn test_mm512_ror_epi64() {
        let a = _mm512_set_epi64( 1<<0, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32 );
        let r = _mm512_ror_epi64(a, 1);
        let e = _mm512_set_epi64( 1<<63, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_maskz_ror_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<0 );
    ...
    unsafe fn test_mm512_slli_epi64() {
        ...
        let e = _mm512_set_epi64( 0, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33, 1<<33 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_srli_epi64() {
        ...
        let e = _mm512_set_epi64( 0, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31, 1<<31 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_rolv_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<63, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32 );
        let b = _mm512_set_epi64( 0, 1, 2, 3, 4, 5, 6, 7 );
        let r = _mm512_rolv_epi64(a, b);
        let e = _mm512_set_epi64( 1<<32, 1<<0, 1<<34, 1<<35, 1<<36, 1<<37, 1<<38, 1<<39 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_maskz_rolv_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<62 );
    ...
    unsafe fn test_mm512_rorv_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<0, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32 );
        let b = _mm512_set_epi64( 0, 1, 2, 3, 4, 5, 6, 7 );
        let r = _mm512_rorv_epi64(a, b);
        let e = _mm512_set_epi64( 1<<32, 1<<63, 1<<30, 1<<29, 1<<28, 1<<27, 1<<26, 1<<25 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_sllv_epi64() {
        ...
        let e = _mm512_set_epi64( 1<<32, 0, 1<<34, 1<<35, 1<<36, 1<<37, 1<<38, 1<<39 );
        assert_eq_m512i(r, e);
    }

    #[simd_test(enable = "avx512f")]
    unsafe fn test_mm512_mask_sllv_epi64() {
        let a = _mm512_set_epi64( 1<<32, 1<<32, 1<<63, 1<<32, 1<<32, 1<<32, 1<<32, 1<<32 );
        ...
        let e = _mm512_set_epi64( 1<<32, 1<<33, 0, 1<<35, 1<<36, 1<<37, 1<<38, 1<<39 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_srlv_epi64() {
        ...
        let e = _mm512_set_epi64( 1<<32, 0, 1<<30, 1<<29, 1<<28, 1<<27, 1<<26, 1<<25 );
        assert_eq_m512i(r, e);
    }
    ...
    unsafe fn test_mm512_or_epi64() {
        ...
        let e = _mm512_set_epi64(1<<0|1<<13|1<<15, 0, 0, 0, 0, 0, 0, 1<<1|1<<2|1<<3);
        assert_eq_m512i(r, e);
    }
