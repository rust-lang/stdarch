types! {
    ...
    ///
    /// This type is the same as the `__m256i` type defined by C intrinsic,
    /// representing a 256-bit SIMD register. Usage of this type typically
    /// corresponds to the `lasx` target features for LoongArch.
    ///
    ...
    /// 256-bit wide set of eight `f32` types, LoongArch-specific
    ///
    /// This type is the same as the `__m256` type defined by C intrinsic,
    /// representing a 256-bit SIMD register which internally is consisted of
    /// eight packed `f32` instances. Usage of this type typically corresponds
    /// to the `lasx` target features for LoongArch.
    ///
    ...
    /// always corresponds to `f32x8`, or eight `f32` types packed together.
    ///
    /// The in-memory representation of this type is the same as the one of an
    /// equivalent array (i.e. the in-memory order of elements is the same, and
    ...
    /// 256-bit wide set of four `f64` types, LoongArch-specific
    ///
    /// This type is the same as the `__m256d` type defined by C intrinsic,
    /// representing a 256-bit SIMD register which internally is consisted of
    ...
    /// always corresponds to `f64x4`, or four `f64` types packed together.
    ///
    /// The in-memory representation of this type is the same as the one of an
    /// equivalent array (i.e. the in-memory order of elements is the same, and
    /// there is no padding); however, the alignment is different and equal to
