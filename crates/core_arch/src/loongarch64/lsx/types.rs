types! {
    ...
    ///
    /// This type is the same as the `__m128i` type defined by C intrinsic,
    /// representing a 128-bit SIMD register. Usage of this type typically
    /// corresponds to the `lsx` and up target features for LoongArch.
    ///
    ...
    /// 128-bit wide set of four `f32` types, LoongArch-specific
    ///
    /// This type is the same as the `__m128` type defined by C intrinsic,
    ...
    /// to the `lsx` and up target features for LoongArch.
    ///
    ...
    /// corresponds to `f32x4`, or four `f32` types packed together.
    ///
    /// The in-memory representation of this type is the same as the one of an
    /// equivalent array (i.e. the in-memory order of elements is the same, and
    /// there is no padding); however, the alignment is different and equal to
    ...
    /// 128-bit wide set of two `f64` types, LoongArch-specific
    ///
    /// This type is the same as the `__m128d` type defined by C intrinsic,
    /// representing a 128-bit SIMD register which internally is consisted of
    ...
    /// always corresponds to `f64x2`, or two `f64` types packed together.
    ///
    /// The in-memory representation of this type is the same as the one of an
    /// equivalent array (i.e. the in-memory order of elements is the same, and
    /// there is no padding); however, the alignment is different and equal to
