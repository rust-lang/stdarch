...
impl_gv!("lsx", lsx_vreplgr2vr_b, simdl_splat, m128i, i8x16, i32);
impl_gv!("lsx", lsx_vreplgr2vr_h, simdl_splat, m128i, i16x8, i32);
impl_gv!("lsx", lsx_vreplgr2vr_w, simdl_splat, m128i, i32x4, i32);
impl_gv!("lsx", lsx_vreplgr2vr_d, simdl_splat, m128i, i64x2, i64);

impl_sv!("lsx", lsx_vrepli_b, simdl_splat, m128i, i8x16, 10);
impl_sv!("lsx", lsx_vrepli_h, simdl_splat, m128i, i16x8, 10);
impl_sv!("lsx", lsx_vrepli_w, simdl_splat, m128i, i32x4, 10);
impl_sv!("lsx", lsx_vrepli_d, simdl_splat, m128i, i64x2, 10);
...
impl_vvv!("lsx", lsx_vandn_v, simdl_andn, m128i, u8x16);
impl_vvv!("lsx", lsx_vor_v, simd_or, m128i, u8x16);
impl_vvv!("lsx", lsx_vorn_v, simdl_orn, m128i, u8x16);
impl_vvv!("lsx", lsx_vnor_v, simdl_nor, m128i, u8x16);
...
impl_vvv!("lsx", lsx_vsll_b, simdl_shl, m128i, i8x16);
impl_vvv!("lsx", lsx_vsll_h, simdl_shl, m128i, i16x8);
impl_vvv!("lsx", lsx_vsll_w, simdl_shl, m128i, i32x4);
impl_vvv!("lsx", lsx_vsll_d, simdl_shl, m128i, i64x2);
impl_vvv!("lsx", lsx_vsra_b, simdl_shr, m128i, i8x16);
impl_vvv!("lsx", lsx_vsra_h, simdl_shr, m128i, i16x8);
impl_vvv!("lsx", lsx_vsra_w, simdl_shr, m128i, i32x4);
impl_vvv!("lsx", lsx_vsra_d, simdl_shr, m128i, i64x2);
impl_vvv!("lsx", lsx_vsrl_b, simdl_shr, m128i, u8x16);
...
impl_vvvv!("lsx", lsx_vmadd_b, simdl_madd, m128i, i8x16);
impl_vvvv!("lsx", lsx_vmadd_h, simdl_madd, m128i, i16x8);
impl_vvvv!("lsx", lsx_vmadd_w, simdl_madd, m128i, i32x4);
impl_vvvv!("lsx", lsx_vmadd_d, simdl_madd, m128i, i64x2);
impl_vvvv!("lsx", lsx_vmsub_b, simdl_msub, m128i, i8x16);
...
impl_vvvv!("lsx", lsx_vfmsub_d, simdl_fms, m128d, f64x2);
impl_vvvv!("lsx", lsx_vfnmadd_s, simdl_nfma, m128, f32x4);
