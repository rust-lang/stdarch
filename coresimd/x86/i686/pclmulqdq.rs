...
#[cfg_attr(test, assert_instr(pclmullqlqdq, imm8 = 0))]
#[cfg_attr(test, assert_instr(pclmulhqlqdq, imm8 = 1))]
#[cfg_attr(test, assert_instr(pclmullqhqdq, imm8 = 16))]
#[cfg_attr(test, assert_instr(pclmulhqhqdq, imm8 = 17))]
