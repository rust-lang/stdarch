...
extern "C" {
    ...
    #[link_name = "llvm.experimental.vector.reduce.add.i16.i16x2"]
    fn reduce_add_i16x2(x: i16x2) -> i16;
    #[link_name = "llvm.experimental.vector.reduce.add.u16.u16x2"]
    fn reduce_add_u16x2(x: u16x2) -> u16;
    #[link_name = "llvm.experimental.vector.reduce.add.i32.i32x2"]
    fn reduce_add_i32x2(x: i32x2) -> i32;
    #[link_name = "llvm.experimental.vector.reduce.add.u32.u32x2"]
    fn reduce_add_u32x2(x: u32x2) -> u32;
    #[link_name = "llvm.experimental.vector.reduce.add.i64.i64x2"]
    fn reduce_add_i64x2(x: i64x2) -> i64;
    #[link_name = "llvm.experimental.vector.reduce.add.u64.u64x2"]
    fn reduce_add_u64x2(x: u64x2) -> u64;
    #[link_name = "llvm.experimental.vector.reduce.add.i8.i8x4"]
    fn reduce_add_i8x4(x: i8x4) -> i8;
    #[link_name = "llvm.experimental.vector.reduce.add.u8.u8x4"]
    fn reduce_add_u8x4(x: u8x4) -> u8;
    #[link_name = "llvm.experimental.vector.reduce.add.i16.i16x4"]
    fn reduce_add_i16x4(x: i16x4) -> i16;
    #[link_name = "llvm.experimental.vector.reduce.add.u16.u16x4"]
    fn reduce_add_u16x4(x: u16x4) -> u16;
    #[link_name = "llvm.experimental.vector.reduce.add.i32.i32x4"]
    fn reduce_add_i32x4(x: i32x4) -> i32;
    #[link_name = "llvm.experimental.vector.reduce.add.u32.u32x4"]
    fn reduce_add_u32x4(x: u32x4) -> u32;
    #[link_name = "llvm.experimental.vector.reduce.add.i64.i64x4"]
    fn reduce_add_i64x4(x: i64x4) -> i64;
    #[link_name = "llvm.experimental.vector.reduce.add.u64.u64x4"]
    fn reduce_add_u64x4(x: u64x4) -> u64;
    #[link_name = "llvm.experimental.vector.reduce.add.i8.i8x8"]
    fn reduce_add_i8x8(x: i8x8) -> i8;
    #[link_name = "llvm.experimental.vector.reduce.add.u8.u8x8"]
    fn reduce_add_u8x8(x: u8x8) -> u8;
    #[link_name = "llvm.experimental.vector.reduce.add.i16.i16x8"]
    fn reduce_add_i16x8(x: i16x8) -> i16;
    #[link_name = "llvm.experimental.vector.reduce.add.u16.u16x8"]
    fn reduce_add_u16x8(x: u16x8) -> u16;
    #[link_name = "llvm.experimental.vector.reduce.add.i32.i32x8"]
    fn reduce_add_i32x8(x: i32x8) -> i32;
    #[link_name = "llvm.experimental.vector.reduce.add.u32.u32x8"]
    fn reduce_add_u32x8(x: u32x8) -> u32;
    #[link_name = "llvm.experimental.vector.reduce.add.i64.i64x8"]
    fn reduce_add_i64x8(x: i64x8) -> i64;
    #[link_name = "llvm.experimental.vector.reduce.add.u64.u64x8"]
    fn reduce_add_u64x8(x: u64x8) -> u64;
    #[link_name = "llvm.experimental.vector.reduce.add.i8.i8x16"]
    fn reduce_add_i8x16(x: i8x16) -> i8;
    #[link_name = "llvm.experimental.vector.reduce.add.u8.u8x16"]
    fn reduce_add_u8x16(x: u8x16) -> u8;
    #[link_name = "llvm.experimental.vector.reduce.add.i16.i16x16"]
    fn reduce_add_i16x16(x: i16x16) -> i16;
    #[link_name = "llvm.experimental.vector.reduce.add.u16.u16x16"]
    fn reduce_add_u16x16(x: u16x16) -> u16;
    #[link_name = "llvm.experimental.vector.reduce.add.i32.i32x16"]
    fn reduce_add_i32x16(x: i32x16) -> i32;
    #[link_name = "llvm.experimental.vector.reduce.add.u32.u32x16"]
    fn reduce_add_u32x16(x: u32x16) -> u32;
    #[link_name = "llvm.experimental.vector.reduce.add.i8.i8x32"]
    fn reduce_add_i8x32(x: i8x32) -> i8;
    #[link_name = "llvm.experimental.vector.reduce.add.u8.u8x32"]
    fn reduce_add_u8x32(x: u8x32) -> u8;
    #[link_name = "llvm.experimental.vector.reduce.add.i16.i16x32"]
    fn reduce_add_i16x32(x: i16x32) -> i16;
    #[link_name = "llvm.experimental.vector.reduce.add.u16.u16x32"]
    fn reduce_add_u16x32(x: u16x32) -> u16;
    #[link_name = "llvm.experimental.vector.reduce.add.i8.i8x64"]
    fn reduce_add_i8x64(x: i8x64) -> i8;
    #[link_name = "llvm.experimental.vector.reduce.add.u8.u8x64"]
    fn reduce_add_u8x64(x: u8x64) -> u8;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f32.f32x2"]
    fn reduce_fadd_f32x2(acc: f32, x: f32x2) -> f32;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f64.f64x2"]
    fn reduce_fadd_f64x2(acc: f64, x: f64x2) -> f64;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f32.f32x4"]
    fn reduce_fadd_f32x4(acc: f32, x: f32x4) -> f32;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f64.f64x4"]
    fn reduce_fadd_f64x4(acc: f64, x: f64x4) -> f64;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f32.f32x8"]
    fn reduce_fadd_f32x8(acc: f32, x: f32x8) -> f32;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f64.f64x8"]
    fn reduce_fadd_f64x8(acc: f64, x: f64x8) -> f64;
    #[link_name = "llvm.experimental.vector.reduce.fadd.f32.f32x16"]
