...
simd_i_ty! {
    i16x16: 16, i16, b16x16, i16x16_tests |
...
simd_u_ty! {
    u16x16: 16, u16, b16x16, u16x16_tests |
...
simd_b_ty! {
    b16x16: 16, i16, b16x16_tests |
    i16, i16, i16, i16, i16, i16, i16, i16,
    i16, i16, i16, i16, i16, i16, i16, i16 |
    x0, x1, x2, x3, x4, x5, x6, x7,
    x8, x9, x10, x11, x12, x13, x14, x15 |
    /// A 256-bit vector with 16 `bool` lanes.
}

simd_i_ty! {
    i32x8: 8, i32, b32x8, i32x8_tests |
...
simd_b_ty! {
    b32x8: 8, i32, b32x8_tests |
    i32, i32, i32, i32, i32, i32, i32, i32 |
    x0, x1, x2, x3, x4, x5, x6, x7 |
    /// A 256-bit vector with 8 `bool` lanes.
}

simd_i_ty! {
    i64x4: 4, i64, b64x4, i64x4_tests |
    i64, i64, i64, i64 |
    x0, x1, x2, x3 |
